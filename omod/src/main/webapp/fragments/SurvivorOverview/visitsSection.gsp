...
<div class="info-section">
    ...
    <div class="info-body">
        ...
        <ul>
            <% recentVisits.each{ %>
            <li class="clear">
                <a href="${ui.pageLink("coreapps", "patientdashboard/patientDashboard", [patientId: patient.patient.id, visitId: it.visitId, returnUrl: ui.thisUrl()])}#visits" class="visit-link">
